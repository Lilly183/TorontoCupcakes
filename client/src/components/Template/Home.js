    ...
    <div>
        ...
        <section className="class spad">
            <div className="container">
                ...
                <div className="class__video set-bg" data-setbg={imgRelPath + "class-video.jpg"}>
                        ...
                        <div className="row">
                            <div className="col-lg-4 col-md-4 col-sm-4 col-6">
                                <div className="instagram__pic">
                                    <img src={imgRelPath + "instagram/instagram-1.jpg"} alt=""/>
                                </div>
                            </div>
                            <div className="col-lg-4 col-md-4 col-sm-4 col-6">
                                <div className="instagram__pic middle__pic">
                                    <img src={imgRelPath + "instagram/instagram-2.jpg"} alt=""/>
                                </div>
                            </div>
                            <div className="col-lg-4 col-md-4 col-sm-4 col-6">
                                <div className="instagram__pic">
                                    <img src={imgRelPath + "instagram/instagram-3.jpg"} alt=""/>
                                </div>
                            </div>
                            <div className="col-lg-4 col-md-4 col-sm-4 col-6">
                                <div className="instagram__pic">
                                    <img src={imgRelPath + "instagram/instagram-4.jpg"} alt=""/>
                                </div>
                            </div>
                            <div className="col-lg-4 col-md-4 col-sm-4 col-6">
                                <div className="instagram__pic middle__pic">
                                    <img src={imgRelPath + "instagram/instagram-5.jpg"} alt=""/>
                                </div>
                            </div>
                            <div className="col-lg-4 col-md-4 col-sm-4 col-6">
                                <div className="instagram__pic">
