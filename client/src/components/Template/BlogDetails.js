...
const BlogDetails = () => 
{
  return (
    <div>
        {/* <!-- Blog Hero Begin --> */}
        <div className="blog-hero set-bg" data-setbg={imgRelPath + "blog/details/blog-hero.jpg"}>
                        ...
                        <div className="blog__details__content">
                            ...
                            <div className="blog__details__recipe">
                                <div className="blog__details__recipe__item">
                                    <h6><img src={imgRelPath + "blog/details/user.png"} alt=""/> SERVES</h6>
                                    <span>2 as a main, 4 as a side</span>
                                </div>
                                <div className="blog__details__recipe__item">
                                    <h6><img src={imgRelPath + "blog/details/clock.png"} alt=""/> PREP TIME</h6>
                                    <span>15 minute</span>
                                </div>
                                <div className="blog__details__recipe__item">
                                    <h6><img src={imgRelPath + "blog/details/clock.png"} alt=""/> COOK TIME</h6>
                                    <span>15 minute</span>
                                </div>
                            </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="blog__details__ingredients__pic">
                                            <img src={imgRelPath + "blog/details/blog-details.jpg"} alt=""/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="blog__details__author">
                                <div className="blog__details__author__pic">
                                    <img src={imgRelPath + "blog/details/blog-author.jpg"} alt=""/>
                                </div>
                            ...
                            <div className="blog__details__comment">
                                ...
                                <div className="blog__details__comment__item blog__details__comment__item--reply">
                                    <div className="blog__details__comment__item__pic">
                                        <img src={imgRelPath + "blog/details/comment-2.jpg"} alt=""/>
                                    </div>
                                    <div className="blog__details__comment__item__text">
                                ...
                                <div className="blog__details__comment__item">
                                    <div className="blog__details__comment__item__pic">
                                        <img src={imgRelPath + "blog/details/comment-3.jpg"} alt=""/>
                                    </div>
                                    <div className="blog__details__comment__item__text">
                                        <h6>Michael Luna</h6>
                                        <span>26 Feb 2020</span>
